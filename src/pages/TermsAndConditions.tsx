      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '860px' }}>
          ...
          <div className="legal-section reveal" id="tc-1">
            <h2>1. Introduction, Scope and Acceptance</h2>
          ...
          <div className="legal-section reveal" id="tc-3">
            <h2>3. Nature of Platizio Global and Role of the Parties</h2>
          ...
          <div className="legal-section reveal" id="tc-4">
            <h2>4. No Investment Advice or Recommendation</h2>
          ...
          <div className="legal-section reveal" id="tc-6">
            <h2>6. Account Opening, KYC, Declarations and Verification</h2>
          ...
          <div className="legal-section reveal" id="tc-7">
            <h2>7. Products Offered Through the Platform</h2>
          ...
          <div className="legal-section reveal" id="tc-8">
            <h2>8. Liberalised Remittance Scheme, FEMA and Funding</h2>
          ...
          <div className="legal-section reveal" id="tc-9">
            <h2>9. Fees, Charges, Taxes and Remuneration</h2>
          ...
          <div className="legal-section reveal" id="tc-10">
            <h2>10. Orders, Execution, Settlement and Statements</h2>
          ...
          <div className="legal-section reveal" id="tc-11">
            <h2>11. Custody, Ownership and Investor Protection</h2>
          ...
          <div className="legal-section reveal" id="tc-12">
            <h2>12. Dividends, Taxes and Reporting</h2>
          ...
          <div className="legal-section reveal" id="tc-14">
            <h2>14. Platform Access, Security and User Responsibilities</h2>
          ...
          <div className="legal-section reveal" id="tc-15">
            <h2>15. Technology, Availability and Third-Party Services</h2>
          ...
          <div className="legal-section reveal" id="tc-23">
            <h2>23. Governing Law, Jurisdiction and Dispute Resolution</h2>
          ...
          <div className="legal-section reveal" id="tc-25">
            <h2>25. Contact and Grievance Redressal</h2>
